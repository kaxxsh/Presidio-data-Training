const myProductName = "davesql", myVersion = "0.6.3"; 
...
function start (options, callback) {
	...
	if (config.flUseMySql2) { //6/27/24 by DW
		...
		if (options.flLogQueries !== undefined) { //6/28/24 by DW
			delete options.flLogQueries;
			}
		if (options.flQueueAllRequests !== undefined) {
			delete options.flQueueAllRequests;
			}
		if (options.flUseMySql2 !== undefined) {
			delete options.flUseMySql2;
			}
		if (options.logCallback !== undefined) {
			delete options.logCallback;
			}
		}
